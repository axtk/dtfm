...
import {formatDate, FormatDateOptions, FormatDateTemplate} from './src/formatDate';
...
suite('basic');
is(
    formatDate('2022-12-02T12:34:56.789', '{YY}-{MM}-{DD}'),
    '2022-12-02',
);
is(
    formatDate('2022-12-02T12:34:56.789', '{YY}/{MM}/{DD}'),
...
is(
    formatDate('2022-01-03T12:34:56.789', '{YY}/{MM}/{DD}'),
    '2022/01/03',
);
is(
    formatDate('2022-12-02T12:34:56.789', '{DD}.{MM}'),
    '02.12',
);
is(
    formatDate('2022-12-02T12:34:56.789', '{D}.{MM}'),
    '2.12',
);
is(
    formatDate('2022-07-03T12:34:56.789', '{DD}.{MM}.{yy}'),
    '03.07.22',
);
is(
    formatDate('2002-07-21T12:34:56.789', '{DD}.{MM}.{yy}'),
    '21.07.02',
);
is(
    formatDate('2002-07-03T12:34:56.789', '{D}/{M}/{yy}'),
    '3/7/02',
);
is(
    formatDate('2022-12-02T19:34:56.789', '{HH}:{mm}:{ss}'),
    '19:34:56',
);
is(
    formatDate('2022-12-02T07:34:56.789', '{HH}:{mm}:{ss}'),
    '07:34:56',
);
is(
    formatDate('2022-12-02T19:34:56.789', '{H}:{mm}:{ss}'),
    '19:34:56',
);
is(
    formatDate('2022-12-02T07:34:56.789', '{H}:{mm}:{ss}'),
    '7:34:56',
);
is(
